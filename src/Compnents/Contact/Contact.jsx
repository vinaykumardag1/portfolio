          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            <div  className='py-5'>
              ...
              <form action="" className='flex flex-col gap-5'>
                ...
                <div  className='flex justify-center'>
                  <textarea placeholder='message'  className='text-white bg-black border border-white-500 rounded-lg p-2 w-2/3 h-40 md:h-80' ></textarea>
                </div>
               <div className='w-full md:w-1/2 flex justify-center'>
                <button type='Submit' className='bg-blue-500 w-40 border-none rounded-xl py-3  md:ml-6'>Submit</button>
             </div>
              </form>
